...
public class OrderServiceTest {
    ...
    void createOrder_InvalidTicketId_ThrowsException() {
        ...
        orderRequestDto.setOrderedTickets(List.of(new OrderedTicketDto(ticketId, 50000,1)));

        when(ticketClient.getTicketById(ticketId)).thenReturn(null); // Feign Client Mock
        OrderBusinessException exception = assertThrows(OrderBusinessException.class, () -> {
            orderService.createPendingOrder("username", orderRequestDto);
        });
    ...
    void createOrder_TicketNotOnSale_ThrowsException() {
        ...
        OrderRequestDto orderRequestDto = new OrderRequestDto();
        orderRequestDto.setOrderedTickets(List.of(new OrderedTicketDto(ticketId, 100,1)));
    ...
    void createOrder_InsufficientStock_ThrowsException() {
        ...
        OrderRequestDto orderRequestDto = new OrderRequestDto();
        orderRequestDto.setOrderedTickets(List.of(new OrderedTicketDto(ticketId, 100,2)));
    ...
    void createOrder_WithValidRequest_CreatesOrderWithoutErrors() {
        ...
        doNothing().when(orderConfirmationService).confirmOrderAndPayment(any(PaymentResponse.class), Collections.singletonList(any(PendingOrder.class)));
